...
public class SimulatedAnnealingAgent extends Agent {
	...
	/**
	 * A method to compute the temperature from time. This method is part of
	 * simulated annealing. Feel free to play around with it. I chose to convert
	 * time to temperature using the equation e^(-0.000000001 * time) which should
	 * have temperature decay super slowly.
	 * 
